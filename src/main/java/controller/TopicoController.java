...
import domain.curso.repository.CursoRepository;
import domain.respuesta.Respuesta;
import domain.respuesta.dto.DetalleRespuestaDTO;
import domain.respuesta.repository.RespuestaRepository;
import domain.topico.Estado;
import domain.topico.Topico;
import domain.topico.dto.ActualizarTopicoDTO;
import domain.topico.dto.CrearTopicoDTO;
import domain.topico.dto.DetallesTopicoDTO;
import domain.topico.repository.TopicoRepository;
import domain.topico.validations.create.ValidarTopicoCreado;
import domain.topico.validations.update.ValidarTopicoActualizado;
...
public class TopicoController {
    ...
    public ResponseEntity<Page<DetallesTopicoDTO>> leerTodosTopicos(@PageableDefault(size = 5, sort = {"ultimaActualizacion"},
    ...
    public ResponseEntity<Page<DetallesTopicoDTO>> leerTopicosNoEliminados(@PageableDefault(size = 5,
            sort = {"ultimaActualizacion"}, direction = Sort.Direction.DESC) Pageable pageable){
